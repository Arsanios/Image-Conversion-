...
# executing this script. Please type 'Green_Mult.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key Green_Mult_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc Green_Mult_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../FPGA Project pipeline.srcs/sources_1/ip/Green_Mult/sim/Green_Mult.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.Green_Mult -o Green_Mult_simv
}
...
simulate()
{
  ...
  ./Green_Mult_simv $opts -do simulate.do
}
# Script usage
usage()
{
