...
#
# Generated by Vivado on Thu Oct 20 10:09:03 +0330 2016
...
# Script info
echo -e "RAM_B.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./RAM_B.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../FPGA Project pipeline.srcs/sources_1/ip/RAM_B/RAM_B_sim_netlist.vhdl" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.RAM_B $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.RAM_B -input simulate.do
}
# Script usage
usage()
{
