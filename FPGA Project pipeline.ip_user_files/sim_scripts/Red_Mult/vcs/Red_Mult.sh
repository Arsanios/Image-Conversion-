...
# executing this script. Please type 'Red_Mult.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key Red_Mult_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc Red_Mult_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../FPGA Project pipeline.srcs/sources_1/ip/Red_Mult/sim/Red_Mult.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.Red_Mult -o Red_Mult_simv
}
...
simulate()
{
  ...
  ./Red_Mult_simv $opts -do simulate.do
}
# Script usage
usage()
{
