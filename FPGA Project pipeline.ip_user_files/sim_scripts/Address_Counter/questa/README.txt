...
#
# Generated by export_simulation on Thu Oct 20 14:41:49 +0330 2016
#
################################################################################
...
switch to the './Address_Counter.sh' script.

./Address_Counter.sh -reset_run
...
./Address_Counter.sh -noclean_files

For more information on the script, please type './Address_Counter.sh -help'.
