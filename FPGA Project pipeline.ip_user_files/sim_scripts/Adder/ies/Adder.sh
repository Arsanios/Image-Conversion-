...
#
# Generated by Vivado on Fri Oct 21 13:56:03 +0330 2016
...
# Script info
echo -e "Adder.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./Adder.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../FPGA Project pipeline.srcs/sources_1/ip/Adder/sim/Adder.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.Adder $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.Adder -input simulate.do
}
# Script usage
usage()
{
