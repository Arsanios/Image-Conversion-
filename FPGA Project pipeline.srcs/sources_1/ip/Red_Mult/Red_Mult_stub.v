...
//               Project pipeline/FPGA Project pipeline.srcs/sources_1/ip/Red_Mult/Red_Mult_stub.v}
// Design      : Red_Mult
...
module Red_Mult(CLK, A, SCLR, P)
/* synthesis syn_black_box black_box_pad_pin="CLK,A[7:0],SCLR,P[14:0]" */;
  input CLK;
  input [7:0]A;
  input SCLR;
  output [14:0]P;
