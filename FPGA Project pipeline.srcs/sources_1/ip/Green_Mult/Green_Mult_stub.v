...
//               Project pipeline/FPGA Project pipeline.srcs/sources_1/ip/Green_Mult/Green_Mult_stub.v}
// Design      : Green_Mult
...
module Green_Mult(CLK, A, SCLR, P)
/* synthesis syn_black_box black_box_pad_pin="CLK,A[7:0],SCLR,P[15:0]" */;
  input CLK;
  input [7:0]A;
  input SCLR;
  output [15:0]P;
