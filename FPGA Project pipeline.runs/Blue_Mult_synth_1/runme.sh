...
HD_PWD='C:/Users/Arsany A. Temothaws/Desktop/FPGA Project pipeline/FPGA Project pipeline/FPGA Project pipeline.runs/Blue_Mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Blue_Mult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Blue_Mult.tcl
