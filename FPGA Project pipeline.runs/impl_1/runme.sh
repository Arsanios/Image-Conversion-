...
HD_PWD='C:/Users/Arsany A. Temothaws/Desktop/FPGA Project pipeline/FPGA Project pipeline/FPGA Project pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Complete_Chip.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Complete_Chip.tcl -notrace
