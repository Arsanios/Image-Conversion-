...
HD_PWD='C:/Users/Arsany A. Temothaws/Desktop/FPGA Project pipeline/FPGA Project pipeline/FPGA Project pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Complete_Chip.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Complete_Chip.tcl
