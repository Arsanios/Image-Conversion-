...
HD_PWD='C:/Users/Arsany A. Temothaws/Desktop/FPGA Project pipeline/FPGA Project pipeline/FPGA Project pipeline.runs/Address_Counter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Address_Counter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Address_Counter.tcl
