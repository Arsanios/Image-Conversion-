...
HD_PWD='C:/Users/Arsany A. Temothaws/Desktop/FPGA Project pipeline/FPGA Project pipeline/FPGA Project pipeline.runs/RAM_B_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_B.vds -m64 -mode batch -messageDb vivado.pb -notrace -source RAM_B.tcl
