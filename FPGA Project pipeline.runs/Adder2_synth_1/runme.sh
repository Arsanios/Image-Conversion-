...
HD_PWD='C:/Users/Arsany A. Temothaws/Desktop/FPGA Project pipeline/FPGA Project pipeline/FPGA Project pipeline.runs/Adder2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Adder2.tcl
